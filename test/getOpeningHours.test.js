...
describe('Testes da função getOpeningHours', () => {
  ...
  it('Para os argumentos dataHour fora do intervalo 00:00 ~ 12:00, deve lançar uma exceção com a mensagem: The hour must be between 0 and 12;', () => {
    expect(() => getOpeningHours('Sunday', '13:00-AM')).toThrow('The hour must be between 0 and 12');
  });
  it('Para os minutos fora do intervalo entre 0 ~ 59, deve lançar uma exceção com a mensagem: The minutes must be between 0 and 59;', () => {
    expect(() => getOpeningHours('Sunday', '09:66-AM')).toThrow('The minutes must be between 0 and 59');
  });
  it('Ao chamar a função getOpeningHours sem parâmetro, deve retornar um array com todos os horários de funcionamento;', () => {
